...
bool tow_dof_motion__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tow_dof_motion.msg._joint_command.JointCommand", full_classname_dest, 46) == 0);
  }
  tow_dof_motion__msg__JointCommand * ros_message = _ros_message;
  {  // positions
...
PyObject * tow_dof_motion__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tow_dof_motion.msg._joint_command");
