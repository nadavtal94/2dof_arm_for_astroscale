...
{
  new (message_memory) tow_dof_motion::msg::JointCommand(_init);
}

void JointCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tow_dof_motion::msg::JointCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointCommand_message_member_array[2] = {
  {
    ...
    offsetof(tow_dof_motion::msg::JointCommand, positions),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tow_dof_motion::msg::JointCommand, duration),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointCommand_message_members = {
  "tow_dof_motion::msg",  // message namespace
  "JointCommand",  // message name
  2,  // number of fields
  sizeof(tow_dof_motion::msg::JointCommand),
...
get_message_type_support_handle<tow_dof_motion::msg::JointCommand>()
{
  return &::tow_dof_motion::msg::rosidl_typesupport_introspection_cpp::JointCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tow_dof_motion, msg, JointCommand)() {
  return &::tow_dof_motion::msg::rosidl_typesupport_introspection_cpp::JointCommand_message_type_support_handle;
}
