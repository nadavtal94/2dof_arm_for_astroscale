...
#include "tow_dof_motion/msg/detail/joint_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tow_dof_motion::msg::JointCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tow_dof_motion::msg::JointCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tow_dof_motion::msg::JointCommand *>(
    untyped_ros_message);
...
{
  return &tow_dof_motion::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
