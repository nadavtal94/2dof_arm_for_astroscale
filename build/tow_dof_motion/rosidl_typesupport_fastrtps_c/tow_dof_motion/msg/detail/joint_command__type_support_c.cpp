...
#include "tow_dof_motion/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
...
using _JointCommand__ros_msg_type = tow_dof_motion__msg__JointCommand;
...
size_t get_serialized_size_tow_dof_motion__msg__JointCommand(
  const void * untyped_ros_message,
...
static uint32_t _JointCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tow_dof_motion__msg__JointCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tow_dof_motion
size_t max_serialized_size_tow_dof_motion__msg__JointCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tow_dof_motion__msg__JointCommand;
    is_plain =
      (
...
static size_t _JointCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tow_dof_motion__msg__JointCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tow_dof_motion, msg, JointCommand)() {
